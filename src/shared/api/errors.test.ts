...
const CASES: Array<[string, Error, string, number]> = [
  ...
  ["SkillNotFoundForTransferError", new SkillNotFoundForTransferError(), "SKILL_NOT_FOUND", 404],
  ["CrossOrgTransferError", new CrossOrgTransferError(), "CROSS_ORG_TRANSFER", 404],
  ["CannotTransferToSameOwnerError", new CannotTransferToSameOwnerError(), "CANNOT_TRANSFER_TO_SAME_OWNER", 422],
